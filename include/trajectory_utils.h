...
// linear_interpolate: linearly interpolate between waypoints to create a path
// The waypoints will be defined such that the angular distance between them is
