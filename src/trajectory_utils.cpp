...
// // int get_trajectory_len(waypoint_t start, waypoint_t end, double
// resolution)
// // {
...
// //   // If path length is greater than the maximum allowed, scale the
// resolution
...
// // path
// // // The waypoints will be defined such that the angular distance between
// them
// // is
// // // is constant. Additionally, both joints will reach the end of their path
// at
// // // the same time.
...
// // void linear_interpolate(waypoint_t start, waypoint_t end, waypoint_t
// *path,
// //                         double resolution)
// // {
// //   // Calculate the angular distance between the waypoints
